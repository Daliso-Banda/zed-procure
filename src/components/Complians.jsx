    ...
    <section className="py-20 bg-white border-t border-slate-100 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 bg-procure-navy rounded-3xl p-10 text-center text-white">
            ...
            <button className="bg-procure-copper hover:bg-orange-700 text-white font-bold py-3 px-10 rounded-full transition-all flex items-center gap-2 mx-auto">
